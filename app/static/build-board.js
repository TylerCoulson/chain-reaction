function buildBox(c=0) {
    ...
    box.className = "flex items-center w-full min-w-[1em] rounded text-[2em] aspect-square justify-center transition-[border-color] duration-1000 border-2 border-primary peer-checked:border-none peer-checked:group-[]:border-neutral-content group/row";
    let cell = document.createElement("div");
    cell.className = "flex items-center justify-center border-0 w-full h-full rounded transition-[border-color] duration-1000 border-primary peer-checked:group-[]/row:border-2 peer-checked:group-[]/row:border-secondary";
